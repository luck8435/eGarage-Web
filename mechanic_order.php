...
$sql_4 = "SELECT *  
        from mechanics m
        INNER JOIN garages g on m.garage_id = g.id
...
$mechanics = mysqli_fetch_all($result_4, MYSQLI_ASSOC);
?>
    ...
    if(count($mechanics) != 0){
                ...
                <div class="garage-summary content-box">
                    ...
                    <div class="detail-container">
                        <div class="garage-name"><h1>Mechanic from <?=$garage['garage_name'];?></h1></div>
                        <div class="mechanic-details">
                            <h4>Name - <?=$mechanic['full_name'];?></h4>
                            <h6>Age- <?=$mechanic['age'];?>years</h6>
                            <h6>contact- <?=$mechanic['phone'];?></h6>
                            <h6>id- <?=$mechanic_id; ?></h6>
                        <div class="av">Available- <?=$mechanic['available'];?></div>
                        </div>
                        ...
                        Rating:
                        <?php
                        $rating = $mechanic['mechanic_rating']; 
                        for ($i = 0; $i < 5; $i++) {
                            if ($rating >= $i + 0.8) {
                        ?>
                    ...
                    ?>
                        <div class="button-container">
                            <a href="request.php?mechanic_id=<?=$mechanic_id;?>" class=" gbtn">Book Now</a>
                        </div>
                    </div>
                    <?php
                    }
                ...
                <div class="garage-facility">
                    <div class="page">
                        <h1>Services provided by mechanic</h1>
